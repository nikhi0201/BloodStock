...
import { Droplet, Mail, Lock, ArrowRight, Heart } from "lucide-react"
            ...
            <Card className="border-slate-800 bg-slate-900/90 backdrop-blur-xl text-slate-100 shadow-2xl shadow-red-900/20 overflow-hidden relative">
                ...
                <CardHeader className="text-center pb-2">
                    ...
                    <CardDescription className="text-slate-400">
                        Access your donor profile and save lives.
                    </CardDescription>
                </CardHeader>
                <form onSubmit={handleSubmit}>
                    <CardContent className="space-y-4">
                        ...
                        >
                            ...
                            <Input
                                ...
                                className="bg-slate-950/50 border-slate-800 focus-visible:ring-red-500 transition-all duration-300 focus:border-red-500/50"
                                value={email}
                    ...
                    <CardFooter className="flex flex-col gap-4">
                        ...
                        <div className="text-center text-sm text-slate-400">
                            ...
                            <Link href="/donor/signup" className="text-red-400 hover:text-red-300 hover:underline transition-colors">
                                Sign up
                            </Link>
                        </div>
                        <div className="text-center text-xs text-slate-500">
                            <Link href="/hospital/login" className="hover:text-slate-300 hover:underline transition-colors">
